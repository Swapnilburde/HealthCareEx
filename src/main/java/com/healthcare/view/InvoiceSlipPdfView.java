...
public class InvoiceSlipPdfView extends AbstractPdfView{
	...
	protected void buildPdfDocument(
		...
		Image img =Image.getInstance(new ClassPathResource("static/images/nobel.png").getURL());
		...
		Paragraph title = new Paragraph("NOBAL HOSPITAL",titleFont);
		...
		billdata.getDefaultCell().setBorder(0);
